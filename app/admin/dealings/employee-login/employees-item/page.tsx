...
function EmployeeFormContent() {
  ...
  const handleSave = async () => {
    try {
      ...
      // إعادة التوجيه إلى شاشة قائمة الموظفين الجديدة
      router.push(`/admin/dealings/employee-login/employees-list?refresh=true`)
    } catch (error) {
      ...
      try {
        ...
        if (id) {
          ...
          setFormData(prev => ({ 
            ...
            ID: maxId + 1, 
            Code: maxId + 1,
            IDBranch: branchId ? Number(branchId) : 0
          }))
        }
                 ...
                 <div className="space-y-4">
                   ...
                   <div className="space-y-2">
                     ...
                     <Select 
                       ...
                       disabled={!!branchId}
                     >
                       <SelectTrigger className={branchId ? "bg-gray-50" : ""}>
                     ...
                     {branchId && (
                       <p className="text-xs text-gray-500">الفرع محدد مسبقاً ولا يمكن تغييره</p>
                     )}
                   </div>
