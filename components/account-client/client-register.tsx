...
export default function ClientRegister({ onSuccess, showHeader = true, className = "" }: ClientRegisterProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // استدعاء callback النجاح إذا كان موجوداً
      if (onSuccess) {
        onSuccess()
      }
      ...
      <Card className="shadow-xl border-0">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <User className="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-400 w-4 h-4" />
                    <Input
                      id="Name"
                      name="Name"
                      type="text"
                      ...
                      className="pr-10 text-right border-blue-200 focus:border-blue-500"
                      disabled={loading}
                      required
                    />
                  </div>
                ...
                {/* Mobile */}
                <div className="space-y-2">
                  <Label htmlFor="Mobile" className="text-sm font-medium text-blue-800">
                    رقم الجوال *
                  </Label>
                  <div className="relative">
                    <Phone className="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-400 w-4 h-4" />
                    <Input
                      id="Mobile"
                      name="Mobile"
                      type="tel"
            ...
            {/* زر إظهار/إخفاء التفاصيل الزائدة */}
            <div className="text-center">
              ...
              >
                ...
                <span>
                  {showAdvancedFields ? 'إخفاء التفاصيل الزائدة' : 'إظهار التفاصيل الزائدة'}
                </span>
                <Settings className="w-4 h-4" />
              </Button>
            </div>

            {/* البيانات الإضافية - قابلة للإظهار والإخفاء */}
            {showAdvancedFields && (
              <div className="space-y-6 border-t pt-6">
                ...
                {/* حقول مخفية - القيم الافتراضية (سيتم أخذها عند الحفظ) */}
                <div className="hidden">
                  {/* هذه الحقول مخفية ولكن قيمها محفوظة في formData */}
                  <input type="hidden" name="IDBranch" value={formData.IDBranch} />
                  <input type="hidden" name="BalanceType" value={formData.BalanceType} />
                </div>
              </div>
            )}
